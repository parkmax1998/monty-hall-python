...
## The Why
This program was written in order to create a showcase of why one should switch. The player will be prompted to go through the puzzle and can choose to play again. When the player wishes to end, a correlation table will appear, showing that there is a correlation between switching and winning. This in contrast to the interpretation of the puzzle that switching doesn't matter.
